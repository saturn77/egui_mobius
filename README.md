...
![Latest Version](https://img.shields.io/badge/version-0.3.0--alpha.13-green.svg)
...
egui_mobius follows semantic versioning and is currently in its alpha phase (0.3.0-alpha.14). This version represents:
